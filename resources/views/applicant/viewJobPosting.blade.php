...
<div class="row">
    ...
    <div class="col-xl-8">
        ...
        @php
            $alreadyApplied = \App\Models\Application::where('applicant_id', auth()->id())->where('job_posting_id', $jobPosting->id)->exists();
        @endphp
        ...
        <div class="text-end mt-3">
            ...
            @else
                <form method="POST" action="{{ url('applicant/apply', $jobPosting->slug) }}">
                    @csrf
