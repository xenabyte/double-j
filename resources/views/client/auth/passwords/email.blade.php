    ...
    <div class="row">
        <div class="col-7">
            <div class="text-primary p-4">
                ...
                <p>Reset Password with  {{ !empty($pageGlobalData->setting)?$pageGlobalData->setting->site_name:null }} for Clients.</p>
            </div>
        </div>
...
<div class="card-body pt-0"> 
    ...
    <div class="p-2">
        ...
        <form class="form-horizontal" method="POST" action="{{ url('/client/password/email') }}">
            @csrf
