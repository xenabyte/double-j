...
<div class="col-md-8 col-lg-6 col-xl-5">
    <div class="card overflow-hidden">
        ...
        <div class="card-body pt-0"> 
            ...
            <div class="p-2">
                <form class="needs-validation" role="form" method="POST" action="{{ url('/client/register') }}">
                    @csrf
    ...
    <div class="mt-5 text-center">
        ...
        <div>
            <p>Already have an account ? <a href="{{ url('/client/login') }}" class="fw-medium text-primary"> Login</a> </p>
        </div>
    </div>
