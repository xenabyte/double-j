...
@section('content')
    ...
    <tr>
        <td style="font-size: 14px; line-height: 1.6; color: #343a40;">
            ...
            <p>To help us better understand your needs and match you with the most relevant talent and solutions, please take a moment to complete your client profile.</p>
